...
import static com.ruanyangyang.demo.entity.ResultCode.ERR_NO_AUTHENTICATION;
...
public class ShiroAuthorizationFilter extends FormAuthenticationFilter {
	...
	protected boolean onAccessDenied(ServletRequest request, ServletResponse response) {
		...
		jsonObject.put("code", ERR_NO_AUTHENTICATION.getCode());
		jsonObject.put("msg", ERR_NO_AUTHENTICATION.getMsg());
